...
// @license MIT
// @downloadURL https://update.sleazyfork.org/scripts/537668/Tampermonkey%20Video%20Filter%20v4.user.js
// @updateURL https://update.sleazyfork.org/scripts/537668/Tampermonkey%20Video%20Filter%20v4.meta.js
// ==/UserScript==
...
(function() {
    ...
    style.innerHTML = `
      .card-list__items {
        ...
        gap: 16px !important;  /* space between posts */
        padding: 10px;
        box-sizing: border-box;
      }
      .post-card {
        width: 100% !important;
        max-width: 600px !important; /* nice for desktop but mobile-friendly */
      ...
      .post-card video {
        ...
        border-radius: 6px;
        max-height: 70vh; /* avoid giant fullscreen */
        object-fit: contain;
      }
      .post-card__header {
        font-size: 16px;
...
// @version     1.0
// @author      -
// @description 8/25/2025, 12:41:24 AM
// ==/UserScript==
